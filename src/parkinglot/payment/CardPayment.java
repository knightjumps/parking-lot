...
public final class CardPayment implements Payment {
    ...
    public CardPayment(String paymentToken) { this.paymentToken = paymentToken; }
    public PaymentReceipt pay(String ticketId, BigDecimal amount) {
        if (paymentToken == null || paymentToken.isBlank()) return new PaymentReceipt(false, null, "Missing card token");
