...
public final class ParkingTicket {
    ...
    ParkingTicket(String ticketId, Vehicle vehicle, String floorId, String spotId, Instant entryTime) {
        this.ticketId = ticketId; this.vehicle = vehicle; this.floorId = floorId; this.spotId = spotId; this.entryTime = entryTime;
    }
    ...
    void markPaid(Instant exitTime, BigDecimal amount, String reference) {
        this.exitTime = exitTime; this.paidAmount = amount; this.paymentReference = reference; this.status = TicketStatus.PAID;
    }
    @Override public String toString() { return "%s [%s at %s/%s]".formatted(ticketId, vehicle, floorId, spotId); }
}
